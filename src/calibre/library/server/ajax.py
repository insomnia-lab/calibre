...
class AjaxServer(object):
    ...
    def add_routes(self, connect):
        ...
        connect('ajax_page_book_add', base_href+'/page_book_add', self.ajax_page_book_add)
    ...
    def ajax_page_book_add(self):
        return '<!DOCTYPE html><html><body><h2>Upload a file</h2><form action="upload" method="post" enctype="multipart/form-data"> filename: <input type="file" name="myFile" /><br /><input type="submit" /></form><h2>Download a file</h2><a href="download">This one</a></body></html>'
        index.exposed = True
